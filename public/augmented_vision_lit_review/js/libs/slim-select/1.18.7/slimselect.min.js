    ...
    return function(i) {
        ...
        t.putContent = function(e, t, i) {
            var n = e.offsetHeight
              ...
              , a = i ? s.top : s.top - n
              , o = i ? s.bottom : s.bottom + n;
            return a <= 0 ? "below" : o >= window.innerHeight ? "above" : i ? t : "below"
        }
        ,
        t.debounce = function(n, s, a) {
            var o;
            return void 0 === s && (s = 100),
            void 0 === a && (a = !1),
            function() {
                var e = self
                  , t = arguments
        ...
        t.highlight = function(e, t, i) {
            ...
            var a = e.match(s).index
              , o = a + e.match(s)[0].toString().length
              , l = e.substring(a, o);
            return n = n.replace(s, '<mark class="' + i + '">' + l + "</mark>")
        }
        ,
        function() {
            var e = window;
            ...
            "function" != typeof e.CustomEvent && (t.prototype = e.Event.prototype,
            e.CustomEvent = t)
        }()
    }
    , function(e, t, i) {
        ...
        var n = function() {
            ...
            e.prototype.parseSelectData = function() {
                this.data = [];
                for (var e = this.main.select.element.childNodes, t = 0; t < e.length; t++)
                    if ("OPTGROUP" === e[t].nodeName) {
                        for (var i = {
                            label: e[t].label,
                            options: []
                        }, n = e[t].childNodes, s = 0; s < n.length; s++)
                            if ("OPTION" === n[s].nodeName) {
                                var a = this.pullOptionData(n[s]);
                                i.options.push(a),
                                a.placeholder && "" !== a.text.trim() && (this.main.config.placeholderText = a.text)
                            }
                        this.data.push(i)
                    } else if ("OPTION" === e[t].nodeName) {
                        a = this.pullOptionData(e[t]);
                        this.data.push(a),
                        a.placeholder && "" !== a.text.trim() && (this.main.config.placeholderText = a.text)
                    }
            }
            ...
            e.prototype.setSelectedFromSelect = function() {
                var e = this.main.select.element.options;
                ...
                } else if (-1 !== e.selectedIndex) {
                    var s, a = (s = e[e.selectedIndex]).value;
                ...
                for (var i = 0; i < this.data.length; i++)
                    if (this.data[i].hasOwnProperty("label")) {
                        if (this.data[i].hasOwnProperty("options")) {
                            var n = this.data[i].options;
                            if (n)
                                for (var s = 0; s < n.length; s++)
                                    n[s].placeholder || (n[s].selected = this.shouldBeSelected(n[s], e, t))
                        }
                    } else
                        this.data[i].selected = this.shouldBeSelected(this.data[i], e, t)
            }
            ,
            e.prototype.shouldBeSelected = function(e, t, i) {
                ...
                Array.isArray(t)) {
                    for (var n = 0; n < t.length; n++)
                        if (i in e && String(e[i]) === String(t[n]))
                            return !0
                } else if (i in e && String(e[i]) === String(t))
                    return !0;
                return !1
            }
            ,
            e.prototype.getSelected = function() {
                for (var e = {
                    text: ""
                }, t = [], i = 0; i < this.data.length; i++)
                    if (this.data[i].hasOwnProperty("label")) {
                        if (this.data[i].hasOwnProperty("options")) {
                            var n = this.data[i].options;
                            if (n)
                                for (var s = 0; s < n.length; s++)
                                    n[s].selected && (this.main.config.isMultiple ? t.push(n[s]) : e = n[s])
                        }
                    } else
                        this.data[i].selected && (this.main.config.isMultiple ? t.push(this.data[i]) : e = this.data[i]);
            ...
            e.prototype.removeFromSelected = function(e, t) {
                if (void 0 === t && (t = "id"),
                this.main.config.isMultiple) {
                    for (var i = [], n = this.getSelected(), s = 0; s < n.length; s++)
                        String(n[s][t]) !== String(e) && i.push(n[s][t]);
                    this.setSelected(i, t)
                }
            }
            ,
            ...
            e.prototype.getObjectFromData = function(e, t) {
                void 0 === t && (t = "id");
                for (var i = 0; i < this.data.length; i++) {
                    if (t in this.data[i] && String(this.data[i][t]) === String(e))
                        return this.data[i];
                    if (this.data[i].hasOwnProperty("options")) {
                        var n = this.data[i];
                        if (n.options)
                            for (var s = 0; s < n.options.length; s++)
                                if (String(n.options[s][t]) === String(e))
                                    return n.options[s]
                    }
                }
                return null
                    ...
                    var t = e.map(function(e) {
                        if (e.hasOwnProperty("options")) {
                            ...
                            if (t.options && (i = t.options.filter(function(e) {
                                return -1 !== e.text.toLowerCase().indexOf(s)
                            })),
                            0 !== i.length) {
                        ...
                        if (e.hasOwnProperty("text") && -1 !== e.text.toLowerCase().indexOf(s))
                            return e;
                        return null
                    });
        ...
        function a(e) {
            return void 0 !== e.text || (console.error("Data object option must have at least have a text value. Check object: " + JSON.stringify(e)),
            !1)
        }
        t.default = n,
        t.validateData = function(e) {
            if (!e)
                return console.error("Data must be an array of objects"),
                !1;
            for (var t = 0, i = 0; i < e.length; i++)
                if (e[i].hasOwnProperty("label")) {
                    if (e[i].hasOwnProperty("options")) {
                        var n = e[i].options;
                        if (n)
                            for (var s = 0; s < n.length; s++)
                                a(n[s]) || t++
          ...
          , r = function() {
            function e(e) {
                ...
                document.addEventListener("click", function(e) {
                    e.target && !s.hasClassInTree(e.target, t.config.id) && t.close()
                }),
                window.addEventListener("scroll", s.debounce(function(e) {
                    t.data.contentOpen && "auto" === t.config.showContent && ("above" === s.putContent(t.slim.content, t.data.contentPosition, t.data.contentOpen) ? t.moveContentAbove() : t.moveContentBelow())
                }), !1),
            ...
            e.prototype.selected = function() {
                if (this.config.isMultiple) {
                    for (var e = this.data.getSelected(), t = [], i = 0; i < e.length; i++)
                        t.push(e[i].value);
                    return t
                }
                return (e = this.data.getSelected()) ? e.value : ""
            }
            ,
            ...
            e.prototype.setData = function(e) {
                if (o.validateData(e)) {
                    ...
                    if (this.config.isAjax && i)
                        if (this.config.isMultiple)
                            for (var n = i.reverse(), s = 0; s < n.length; s++)
                                t.unshift(n[s]);
                        else
            ...
            e.prototype.open = function() {
                ...
                if (this.config.isEnabled && !this.data.contentOpen) {
                    if (this.slim.search.input.focus(),
                    this.beforeOpen && this.beforeOpen(),
                    this.config.isMultiple && this.slim.multiSelected ? this.slim.multiSelected.plus.classList.add("ss-cross") : this.slim.singleSelected && (this.slim.singleSelected.arrowIcon.arrow.classList.remove("arrow-down"),
                    ...
                    "up" === this.config.showContent.toLowerCase() ? this.moveContentAbove() : "down" === this.config.showContent.toLowerCase() ? this.moveContentBelow() : "above" === s.putContent(this.slim.content, this.data.contentPosition, this.data.contentOpen) ? this.moveContentAbove() : this.moveContentBelow(),
                    !this.config.isMultiple) {
                        var t = this.data.getSelected();
                        if (t) {
                            var i = t.id
                              , n = this.slim.list.querySelector('[data-id="' + i + '"]');
                            n && s.ensureElementInView(this.slim.list, n)
                        }
                    }
                    setTimeout(function() {
            ...
            e.prototype.close = function() {
                var e = this;
                this.data.contentOpen && (this.beforeClose && this.beforeClose(),
                this.config.isMultiple && this.slim.multiSelected ? (this.slim.multiSelected.container.classList.remove(this.config.openAbove),
                this.slim.multiSelected.container.classList.remove(this.config.openBelow),
                this.slim.multiSelected.plus.classList.remove("ss-cross")) : this.slim.singleSelected && (this.slim.singleSelected.container.classList.remove(this.config.openAbove),
                ...
                setTimeout(function() {
                    ...
                    e.config.isMultiple && e.slim.multiSelected ? (e.slim.multiSelected.container.classList.remove(e.config.openAbove),
                    e.slim.multiSelected.container.classList.remove(e.config.openBelow)) : e.slim.singleSelected && (e.slim.singleSelected.container.classList.remove(e.config.openAbove),
            ...
            e.prototype.moveContentAbove = function() {
                ...
                this.config.isMultiple && this.slim.multiSelected ? (this.slim.multiSelected.container.classList.remove(this.config.openBelow),
                this.slim.multiSelected.container.classList.add(this.config.openAbove)) : this.slim.singleSelected && (this.slim.singleSelected.container.classList.remove(this.config.openBelow),
            ...
            e.prototype.moveContentBelow = function() {
                ...
                this.config.isMultiple && this.slim.multiSelected ? (this.slim.multiSelected.container.classList.remove(this.config.openAbove),
                this.slim.multiSelected.container.classList.add(this.config.openBelow)) : this.slim.singleSelected && (this.slim.singleSelected.container.classList.remove(this.config.openAbove),
                this.slim.singleSelected.container.classList.add(this.config.openBelow))
            }
            ,
            e.prototype.enable = function() {
                this.config.isEnabled = !0,
                this.config.isMultiple && this.slim.multiSelected ? this.slim.multiSelected.container.classList.remove(this.config.disabled) : this.slim.singleSelected && this.slim.singleSelected.container.classList.remove(this.config.disabled),
            ...
            e.prototype.disable = function() {
                ...
                this.config.isMultiple && this.slim.multiSelected ? this.slim.multiSelected.container.classList.add(this.config.disabled) : this.slim.singleSelected && this.slim.singleSelected.container.classList.add(this.config.disabled),
                this.select.triggerMutationObserver = !1,
            ...
            e.prototype.search = function(t) {
                if (this.data.searchValue !== t)
                    if (this.slim.search.input.value = t,
                    this.config.isAjax) {
                        var i = this;
                        this.config.isSearching = !0,
                        this.render(),
                        this.ajax && this.ajax(t, function(e) {
                            i.config.isSearching = !1,
                            Array.isArray(e) ? (e.unshift({
                                text: "",
                                placeholder: !0
                            }),
                            i.setData(e),
                            i.data.search(t),
                            i.render()) : "string" == typeof e ? i.slim.options(e) : i.render()
                        })
                    } else
                        this.data.search(t),
                        this.render()
            ...
            e.prototype.render = function() {
                this.config.isMultiple ? this.slim.values() : (this.slim.placeholder(),
                this.slim.deselect()),
                this.slim.options()
            }
            ,
        ...
        var n = function() {
            ...
            return e.prototype.setValue = function() {
                if (this.main.data.getSelected()) {
                    if (this.main.config.isMultiple)
                        for (var e = this.main.data.getSelected(), t = this.element.options, i = 0; i < t.length; i++) {
                            var n = t[i];
                            n.selected = !1;
                            for (var s = 0; s < e.length; s++)
                                e[s].value === n.value && (n.selected = !0)
                        }
                    else {
            ...
            e.prototype.addMutationObserver = function() {
                ...
                this.main.config.isAjax || (this.mutationObserver = new MutationObserver(function(e) {
                    t.triggerMutationObserver && (t.main.data.parseSelectData(),
                    t.main.data.setSelectedFromSelect(),
                    t.main.render(),
            ...
            e.prototype.create = function(e) {
                ...
                for (var t = 0; t < e.length; t++)
                    if (e[t].hasOwnProperty("options")) {
                        var i = e[t]
                          , n = document.createElement("optgroup");
                        if (n.label = i.label,
                        i.options)
                            for (var s = 0; s < i.options.length; s++)
                                n.appendChild(this.createOption(i.options[s]));
                        this.element.appendChild(n)
                    } else
                        this.element.appendChild(this.createOption(e[t]))
            }
            ,
            e.prototype.createOption = function(t) {
                var i = document.createElement("option");
                return i.value = t.value || t.text,
        ...
        var o = i(0)
          ...
          , n = function() {
            function e(e) {
                ...
                this.main.config.isMultiple ? (this.multiSelected = this.multiSelectedDiv(),
                this.container.appendChild(this.multiSelected.container)) : (this.singleSelected = this.singleSelectedDiv(),
            ...
            return e.prototype.containerDiv = function() {
                ...
                return e.style.cssText = this.main.config.style,
            ...
            e.prototype.updateContainerDivClass = function(e) {
                ...
                for (var t = 0; t < this.main.config.class.length; t++)
                    e.classList.add(this.main.config.class[t])
            }
            ,
            e.prototype.singleSelectedDiv = function() {
                ...
                return a.classList.add("arrow-down"),
                s.appendChild(a),
                e.appendChild(s),
                e.onclick = function() {
            ...
            e.prototype.deselect = function() {
                if (this.singleSelected) {
                    if (!this.main.config.allowDeselect)
                        return void this.singleSelected.deselect.classList.add("ss-hide");
            ...
            e.prototype.multiSelectedDiv = function() {
                ...
                i.classList.add(this.main.config.values),
                e.appendChild(i);
                var n = document.createElement("div");
                n.classList.add(this.main.config.add);
                var s = document.createElement("span");
                return s.classList.add(this.main.config.plus),
                s.onclick = function(e) {
                    t.main.data.contentOpen && (t.main.close(),
                    e.stopPropagation())
                }
                ,
                n.appendChild(s),
            ...
            e.prototype.values = function() {
                if (this.multiSelected) {
                    for (var e, t = this.multiSelected.values.childNodes, i = this.main.data.getSelected(), n = [], s = 0; s < t.length; s++) {
                        e = !0;
                        for (var a = t[s], o = 0; o < i.length; o++)
                            String(i[o].id) === String(a.dataset.id) && (e = !1);
                        e && n.push(a)
                    }
                    for (var l = 0; l < n.length; l++)
                        n[l].classList.add("ss-out"),
                        this.multiSelected.values.removeChild(n[l]);
                    t = this.multiSelected.values.childNodes;
                    for (o = 0; o < i.length; o++) {
                        e = !1;
                        for (s = 0; s < t.length; s++) {
                            a = t[s];
                            String(i[o].id) === String(a.dataset.id) && (e = !0)
                        }
                        e || (0 !== t.length && HTMLElement.prototype.insertAdjacentElement ? 0 === o ? this.multiSelected.values.insertBefore(this.valueDiv(i[o]), t[o]) : t[o - 1].insertAdjacentElement("afterend", this.valueDiv(i[o])) : this.multiSelected.values.appendChild(this.valueDiv(i[o])))
                    }
                    if (0 === i.length) {
                        var r = document.createElement("span");
                        r.classList.add(this.main.config.disabled),
                        r.innerHTML = this.main.config.placeholderText,
                        this.multiSelected.values.innerHTML = r.outerHTML
                    }
                }
            }
            ,
            e.prototype.valueDiv = function(s) {
                var a = this
                  , e = document.createElement("div");
                e.classList.add(this.main.config.value),
                e.dataset.id = s.id;
                var t = document.createElement("span");
                ...
                e.appendChild(t);
                var i = document.createElement("span");
                return i.classList.add(this.main.config.valueDelete),
                i.innerHTML = "x",
                i.onclick = function(e) {
                    if (e.preventDefault(),
                    e.stopPropagation(),
                    a.main.config.isEnabled)
                        if (a.main.beforeOnChange) {
                            for (var t = a.main.data.getSelected(), i = JSON.parse(JSON.stringify(t)), n = 0; n < i.length; n++)
                                i[n].id === s.id && i.splice(n, 1);
                            !1 !== a.main.beforeOnChange(i) && (a.main.data.removeFromSelected(s.id, "id"),
                            a.main.render(),
            ...
            e.prototype.contentDiv = function() {
                var e = document.createElement("div");
                return e.classList.add(this.main.config.content),
                e
            }
            ,
            e.prototype.searchDiv = function() {
                ...
                this.main.config.showSearch || (e.classList.add(this.main.config.hide),
                n.readOnly = !0),
                n.type = "search",
                ...
                n.onkeydown = function(e) {
                    "ArrowUp" === e.key ? (s.main.open(),
                    s.highlightUp(),
                    e.preventDefault()) : "ArrowDown" === e.key ? (s.main.open(),
                    s.highlightDown(),
                    e.preventDefault()) : "Tab" === e.key ? s.main.close() : "Enter" === e.key && e.preventDefault()
                }
                ,
                n.onkeyup = function(e) {
                    var t = e.target;
                    if ("Enter" === e.key) {
                        if (s.main.addable && e.ctrlKey)
                            return a.click(),
                            e.preventDefault(),
                        ...
                        "ArrowUp" === e.key || "ArrowDown" === e.key || ("Escape" === e.key ? s.main.close() : s.main.config.showSearch && s.main.data.contentOpen ? s.main.search(t.value) : n.value = "");
                    e.preventDefault(),
                    e.stopPropagation()
                }
                ,
                ...
                if (this.main.addable) {
                    ...
                    a.onclick = function(e) {
                        if (s.main.addable) {
                            ...
                            if ("" === t.trim())
                                return void s.search.input.focus();
                            var i = s.main.addable(t)
                              , n = "";
                            if (!i)
                                return;
                            if ("object" == typeof i)
                                l.validateOption(i) && (s.main.addData(i),
                                n = i.value ? i.value : i.text);
                            else
                                s.main.addData(s.main.data.newOption({
                                    text: i,
                                    value: i
                                })),
                                n = i;
                            ...
                            s.main.config.closeOnSelect && setTimeout(function() {
                                s.main.close()
                            }, 100)
                        }
                    }
            ...
            e.prototype.highlightUp = function() {
                ...
                if (t && t.classList.contains(this.main.config.optgroupLabel) && (t = null),
                null === t) {
                    var n = e.parentNode;
                ...
                t && (e && e.classList.remove(this.main.config.highlighted),
                t.classList.add(this.main.config.highlighted),
                o.ensureElementInView(this.list, t))
            }
            ,
            e.prototype.highlightDown = function() {
                var e = this.list.querySelector("." + this.main.config.highlighted)
                  , t = null;
                if (e)
                    for (t = e.nextSibling; null !== t && t.classList.contains(this.main.config.disabled); )
                        t = t.nextSibling;
                else
                    t = this.list.querySelector("." + this.main.config.option + ":not(." + this.main.config.disabled + ")");
                if (null === t && null !== e) {
                    var i = e.parentNode;
                    if (i.classList.contains(this.main.config.optgroup))
                        if (i.nextSibling)
                            t = i.nextSibling.querySelector("." + this.main.config.option + ":not(." + this.main.config.disabled + ")")
                }
                t && (e && e.classList.remove(this.main.config.highlighted),
                t.classList.add(this.main.config.highlighted),
                o.ensureElementInView(this.list, t))
            ...
            e.prototype.listDiv = function() {
                ...
                return l.classList.add(this.main.config.list),
                l.addEventListener("wheel", function(e) {
                    ...
                    return !a && i - n - t < -s ? (l.scrollTop = i,
                    o()) : a && t < s ? (l.scrollTop = 0,
                    o()) : void 0
                }),
                l
            }
            ...
            e.prototype.options = function(e) {
                ...
                if ((this.list.innerHTML = "") !== e)
                    return (t = document.createElement("div")).classList.add(this.main.config.option),
                    t.classList.add(this.main.config.disabled),
                    t.innerHTML = e,
                ...
                if (0 === i.length) {
                    var n = document.createElement("div");
                    return n.classList.add(this.main.config.option),
                    n.classList.add(this.main.config.disabled),
                    n.innerHTML = this.main.config.searchText,
                    void this.list.appendChild(n)
                }
                for (var s = 0; s < i.length; s++)
                    if (i[s].hasOwnProperty("label")) {
                        var a = i[s]
                          , o = document.createElement("div");
                        o.classList.add(this.main.config.optgroup);
                        var l = document.createElement("div");
                        l.classList.add(this.main.config.optgroupLabel),
                        l.innerHTML = a.label,
                        o.appendChild(l);
                        var r = a.options;
                        if (r)
                            for (var c = 0; c < r.length; c++)
                                o.appendChild(this.option(r[c]));
                        this.list.appendChild(o)
                    } else
                        this.list.appendChild(this.option(i[s]))
            }
            ,
            e.prototype.option = function(e) {
                if (e.placeholder) {
                    var t = document.createElement("div");
                    return t.classList.add(this.main.config.option),
                ...
                i.dataset.id = e.id,
                this.main.config.searchHighlight && this.main.slim && e.innerHTML && "" !== this.main.slim.search.input.value.trim() ? i.innerHTML = o.highlight(e.innerHTML, this.main.slim.search.input.value, this.main.config.searchHighlighter) : e.innerHTML && (i.innerHTML = e.innerHTML),
                ...
                return i.addEventListener("click", function(e) {
                    if (e.preventDefault(),
                    e.stopPropagation(),
                    !(a.main.config.limit && Array.isArray(s) && a.main.config.limit <= s.length)) {
                        var t = this.dataset.id;
                        if (a.main.beforeOnChange) {
                            var i = void 0
                              , n = JSON.parse(JSON.stringify(a.main.data.getObjectFromData(t)));
                            n.selected = !0,
                            a.main.config.isMultiple ? (i = JSON.parse(JSON.stringify(s))).push(n) : i = JSON.parse(JSON.stringify(n)),
                            !1 !== a.main.beforeOnChange(i) && a.main.set(t, "id", a.main.config.closeOnSelect)
                        } else
                            a.main.set(t, "id", a.main.config.closeOnSelect)
                    }
                }),
                (e.disabled || s && o.isValueInArrayOfObjects(s, "id", e.id)) && (i.onclick = null,
